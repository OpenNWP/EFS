...
#SHELL=/bin/bash
#PYTHONPATH=/usr/bin
#20 3 * * * /home/ubuntu/EFS/op_configs/game_op.sh > /home/ubuntu/log_0Z 2>&1
#20 9 * * * /home/ubuntu/EFS/op_configs/game_op.sh > /home/ubuntu/log_6Z 2>&1
#20 15 * * * /home/ubuntu/EFS/op_configs/game_op.sh > /home/ubuntu/log_12Z 2>&1
#20 21 * * * /home/ubuntu/EFS/op_configs/game_op.sh > /home/ubuntu/log_18Z 2>&1
