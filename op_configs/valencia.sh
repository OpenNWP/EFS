...
# This script nests L-GAME into the ICON-EU model.
...
model_source_id=1 # defines with which model to initialize the run
...
game_home_dir=~/L-GAME # the home directory of GAME
