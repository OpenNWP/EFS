...
efs_home_dir=~/code/EFS # directory of EFS
...
real2game_home_dir=~/code/real2GAME # the directory where real2GAME resides
model_home_dir=~/code/GAME # the home directory of the model
