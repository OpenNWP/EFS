...
python3 $backend_home/py/grib2json.py $model_home_dir/output/$run_id/$run_id+$((6*3600))s_surface.grb2 ~/website/worldview/public/data/weather/current/current-wind-surface-level-icon.json
if [ $? -ne 0 ]
then
