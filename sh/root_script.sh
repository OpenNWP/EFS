...
# executing real2GAME
$real2game_home_dir/run.sh $model_id 1 $nsoillays $n_layers $res_id $omp_num_threads $real2game_home_dir $background_file 1 $analysis_year $analysis_month $analysis_day $analysis_hour_extended_string $model_home_dir
