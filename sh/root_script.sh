...
then
$efs_home_dir/plot_scripts/maps_server_0.sh 0 $map_plot_interval_early $analysis_hour $analysis_day $analysis_month $analysis_year $figs_save_path/visualizations/$analysis_hour"UTC" $game_home_dir $run_id $((72*3600))
$efs_home_dir/plot_scripts/maps_server_0.sh $((72*3600 + $map_plot_interval_late)) $map_plot_interval_late $analysis_hour $analysis_day $analysis_month $analysis_year $figs_save_path/visualizations/$analysis_hour"UTC" $game_home_dir $run_id $run_span
else
$efs_home_dir/plot_scripts/maps_server_0.sh 0 $map_plot_interval_early $analysis_hour $analysis_day $analysis_month $analysis_year $figs_save_path/visualizations/$analysis_hour"UTC" $game_home_dir $run_id $run_span
fi
