...
diff_h_smag_div=1.0 # horizontal diffusion Smagorinsky factor acting on divergent movements
diff_h_smag_rot=0.1 # horizontal diffusion Smagorinsky factor acting on vortical movements
