...
diff_h_smag_div=1.43 # horizontal diffusion Smagorinsky factor acting on divergent movements
diff_h_smag_rot=0.05 # horizontal diffusion Smagorinsky factor acting on vortical movements
...
precipitation_droplets_velocity=0.3 # sedimentation velocity of precipitation droplets
