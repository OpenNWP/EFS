...
disp_shortname_list=(
2t prmsl surface_wind tcc rprate sprate cape
...
plot_intervals_list=(
$plot_interval $plot_interval $plot_interval $plot_interval $plot_interval $plot_interval $plot_interval
...
scope_list=(
CEU CEU CEU CEU CEU CEU CEU
) # the areas of the plots
projections_list=(
Gnomonic Gnomonic Gnomonic Gnomonic Gnomonic Gnomonic Gnomonic
